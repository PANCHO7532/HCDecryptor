...
function parseDecoded(data, tlsBuild) {
    ...
    result["tlsPredefPort"] = predefinedPorts[parseInt(data[5])]; //unknown numeric value
    result["sshPort"] = Buffer.from(data[6], "base64").toString();
    result["sshUser"] = Buffer.from(data[7], "base64").toString();
