...
function parseDecoded(data) {
    ...
    if(data["security"]) {
        response["blockedRoot"] = data["security"]["blockRooted"].toString();
        response["mobileData"] = data["security"]["onlyMobileNetwork"].toString();
        response["googlePlay"] = data["security"]["onlyPlayStore"].toString();
    ...
    response["credits"] = "Credits to ReverseLIvE for the research of this format.";
